...
<head>
    ...
    <!-- bootstrap css -->
    <link id="rtl-link" rel="stylesheet" type="text/css" href="{{ asset('frontend_asset/css/vendors/bootstrap.css') }}">
...
<link id="color-link" rel="stylesheet" type="text/css" href="{{ asset('frontend_asset/css/dark.css') }}">
</head>

<body class="bg-effect dark">
    ...
    <header class="pb-md-4 pb-0">
        ...
        <div class="top-nav top-header sticky-header">
            <div class="container-fluid-lg">
                <div class="row">
                    <div class="col-12 col-sm-12 mr-5">
                        <div class="navbar-top">
                            ...
                            <a href="{{ url('/') }}" class="web-logo nav-logo">
                                <img src="{{ asset('frontend_asset/images/logo/4.png') }}" class="img-fluid blur-up lazyload" alt="">
                            </a>
                            ...
                            <div class="rightside-box">
                                ...
                                <ul class="right-side-menu">
                                    ...
                                    <li class="right-side">
                                        <a href="contact-us.html" class="delivery-login-box">
                                            ...
                                            <div class="delivery-detail">
                                                <h6 style="font-size: 14px">24/7 Delivery</h6>
                                                <h5 style="font-size: 14px">+91 888 104 2340</h5>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="right-side">
                                        ...
                                        <div class="onhover-dropdown header-badge">
                                            <button type="button" class="btn p-0 position-relative header-wishlist">
                                                <i data-feather="shopping-cart"></i>
                                                    ...
                                                    <span class="position-absolute top-0 start-100 translate-middle badge">{{ App\Models\card::where('customer_id', Auth::guard('customer')->id())->count() }}
                                            ...
                                            <div class="onhover-div">
                                                ...
                                                @php
                                                    $total = 0;
                                                @endphp
                                                    @foreach (App\Models\card::where('customer_id', Auth::guard('customer')->id())->get() as $card)
                                                    <li class="product-box-contain">
                                                        <div class="drop-cart">
                                                            <a href="product-left-thumbnail.html" class="drop-image">
                                                                <img style="width: 50px" src="{{ asset('uplode/product') }}/{{ $card->rel_to_pro->product_img }}"
                                                                    class="blur-up lazyload" alt="">
                                                            </a>

                                                            <div class="drop-contain">
                                                                <a href="product-left-thumbnail.html">
                                                                    <h5>{{ $card->rel_to_pro->product_name }}</h5>
                                                                </a>
                                                                <h6><span>{{ $card->quantity }} x</span>TK {{ number_format($card->rel_to_pro->total_price) }}</h6>

                                                            </div>
                                                            <a href="{{ route('card.delete', $card->id) }}" class="close-button close_button ">
                                                ...
                                                <div class="price-box">
                                                    <h5>Total :</h5>
                                                    <h4 class="theme-color fw-bold">TK {{ number_format($total) }}</h4>
                                                </div>

                                                <div class="button-group ">
                                                    <a href="{{ route('product.card') }}" class="btn btn-sm cart-button">View Cart</a>
                                    ...
                                    <li class="right-side onhover-dropdown">
                                        ...
                                        @auth('customer')
                                            <div class="onhover-div onhover-div-login mt-3">
                                                <ul class="user-box-name">
                                                    <li class="product-box-contain mb-2">
                                                        <i></i>
                                            ...
                                            <div class="delivery-detail me-2 mt-1">
                                        ...
                                        @else
                                            <div class="onhover-div onhover-div-login">
                                                <ul class="user-box-name">
                                                    <li class="product-box-contain">
                                                        <i></i>
                                                        <a href="{{ route('customer.log.view') }}">Log In</a>
                                                    </li>

                                                    <li class="product-box-contain">
                                                        <a href="{{ route('customer.reg') }}">Register</a>
                                                    </li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="footer-logo">
                            <div class="theme-logo">
                                <a href="{{ url('/') }}">
                                    <img src="{{ asset('frontend_asset/images/logo/1.png') }}" class="blur-up lazyload" alt="">
                                </a>
                            </div>
