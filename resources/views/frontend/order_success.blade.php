                ...
                <div class="breadscrumb-contain breadscrumb-order">
                    <div class="order-box">
                        ...
                        <div class="order-contain">
                            ...
                            <h6>Order ID: {{ session('order_id') }}</h6>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="product-detail">
                                        <div class="product border-0">
                                            <a href="product.left-sidebar.html" class="product-image">
                                                <img src="{{ asset('uplode/product') }}/{{ $order->rel_to_pro->product_img }}"
                                                    class="img-fluid blur-up lazyload" alt="">
                                            </a>
                                            <div class="product-detail">
                                                <ul>
                                                    <li class="name">
                                                        <a>{{ $order->rel_to_pro->product_name }}</a>
                                                    </li>

                                                    <li class="text-content">Sold By: {{ $order->rel_to_pro->rel_to_brand->brand_name }}</li>

                                                    <li class="text-content">Quantity - {{ $order->quantity }} KG</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="price">
                                        ...
                                        <h6 class="theme-color">{{ $order->rel_to_pro->total_price }} TK</h6>
                                    </td>

                                    <td class="quantity">
                                        <h4 class="table-title text-content">Qty</h4>
                                        <h4 class="text-title"> {{ $order->quantity }} KG</h4>
                                    </td>

                                    <td class="subtotal">
                                        @php
                                            $total = $order->rel_to_pro->total_price*$order->quantity;
                                        @endphp
                    ...
                    <div class="col-lg-12 col-sm-6">
                        <div class="summery-box">
                            <div class="summery-header">
                                <h3>Price Details</h3>
                                <h5 class="ms-auto theme-color">({{ App\Models\orderProduct::where('order_id', session('order_id'))->count() }})</h5>
                            </div>

                            <ul class="summery-contain">
                                <li>
                                    <h4>SubTotal</h4>
                                    <h4 class="price">{{ number_format(session('subtotal')) }} TK</h4>
                                </li>

                                <li>
                                    <h4>Shipping</h4>
                                    <h4 class="price theme-color">(+) {{ number_format(session('shipping')) }} TK</h4>
                                </li>

                                <li>
                                    <h4>Coupon Discount</h4>
                                    <h4 class="price text-danger">(-) {{ number_format(session('discount')) }}%</h4>
                                </li>
                            </ul>
                            ...
                            <ul class="summery-total">
                                <li class="list-total">
                                    <h4>Total (BDT)</h4>
                                    <h4 class="price">{{ number_format(session('grand_total')) }} TK</h4>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-sm-6">
                        <div class="summery-box">
                            ...
                            <ul class="summery-contain pb-0 border-bottom-0">
                                <li class="d-block">
                                    <h4>{{ $billing_details->first()->address }}</h4>
                                    <h4 class="mt-2">{{ $billing_details->first()->rel_to_city->name }}, {{ $billing_details->first()->rel_to_country->name }}, {{ $billing_details->first()->zip }}</h4>
                                </li>
                            ...
                            <ul class="summery-total">
                                <li class="list-total border-top-0 pt-2">
                                    <h4 class="fw-bold">{{ $order->created_at->format('d-M-Y') }}</h4>
                                </li>
                            </ul>
                        </div>
                    </div>
