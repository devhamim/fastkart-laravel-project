            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="theme-form theme-form-2 mega-form" action="{{ route('account.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="mb-4 row align-items-center">
                                    <label class="form-label-title col-sm-2 mb-0">First Name</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" name="fast_name" value="{{ Auth::user()->fast_name }}" type="text"
