...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data = array();
        $post_data['total_amount'] = $data['grand_total']; # You cant not pay less than 10
    ...
    public function success(Request $request)
    {
        ...
        order::insert([
            ...
            'subtotal'=>$data->first()->subtotal,
            'shipping'=>$data->first()->shipping,
        ...
        $cards = card::where('customer_id', $data->first()->customer_id,)->get();
